...
class AgenticLoopService
  ...
  def execute_generate_image(input, post)
    result = AtlasCloudImageService.new.generate_image(prompt: input['prompt'], model: input['model'] || 'openai/gpt-image-1-mini/text-to-image', aspect_ratio: input['aspect_ratio'] || '1:1')
